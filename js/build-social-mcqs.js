...
const src = {
  ...
  ch5:  loadVar('social-mcqs.js', 'SOCIAL_CH5') || loadVar('social-mcqs.js', 'CH5_SOCIAL'),
  ch6:  loadVar('social-mcqs.js', 'SOCIAL_CH6') || loadVar('social-mcqs.js', 'CH6_SOCIAL'),
  ch7:  loadVar('social-ch4-ch7-ch8.js', 'SOCIAL_CH7'),
  ch8:  loadVar('social-ch4-ch7-ch8.js', 'SOCIAL_CH8'),
  ch9:  loadVar('social-ch9-ch10-mcqs.js', 'SOCIAL_CH9') || loadVar('social-ch9-ch10-mcqs.js', 'CH9_SOCIAL'),
  ch10: loadVar('social-ch9-ch10-mcqs.js', 'SOCIAL_CH10') || loadVar('social-ch9-ch10-mcqs.js', 'CH10_SOCIAL'),
